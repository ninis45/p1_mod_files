...
$lang['files:id']						    = 'ID';
$lang['files:keywords']						    = 'Palabras clave';
...
$lang['files:replace_warning']				= 'Advertencia : No reemplace un archivo con un archivo de un tipo diferente ( por ejemplo, .jpg .png )'; #translate
