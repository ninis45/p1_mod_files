	...
	public function index()
	{
		$this->template
			...
			//->append_js('module::functions.js')
             ->append_js('module::files.factory.js')
             ->append_js('module::files.controller.js')
            ...
            ->append_metadata('<script type="text/javascript">var parent_id=0,folders_sidebar='.json_encode(Files::folder_tree()).'</script>')
